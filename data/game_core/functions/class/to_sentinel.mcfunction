...
tellraw @s {"text":""}
tellraw @s ["",{"text":" ▸ ","color":"gold"},{"text":"行為獎勵: ","color":"yellow"},{"text":"蹲下且靜止不動，每秒 +$1","color":"white"}]
tellraw @s ["",{"text":" ▸ ","color":"gold"},{"text":"初始武器: ","color":"yellow"},{"text":"M1895 左輪手槍","color":"white"}]
tellraw @s ["",{"text":" ▸ ","color":"gold"},{"text":"固有投擲物: ","color":"yellow"},{"text":"擊殺敵人後自動補充 ","color":"white"},{"text":"煙霧彈, 手榴彈, 燃燒彈","color":"aqua"}]
