...
execute as @a[scores={switch_class=1}] run tellraw @s {"text":""}
execute as @a[scores={switch_class=1}] run tellraw @s ["",{"text":" + ","color":"green"},{"text":"Buff:「折扣特權」","color":"green"}]
execute as @a[scores={switch_class=1}] run tellraw @s ["",{"text":"   效果: ","color":"gray"},{"text":"商店所有物品購買價格降低 20%。","color":"white"}]
...
execute as @a[scores={switch_class=1}] run tellraw @s {"text":""}
execute as @a[scores={switch_class=1}] run tellraw @s ["",{"text":" ▸ ","color":"gold"},{"text":"初始武器: ","color":"yellow"},{"text":"CZ75 手槍","color":"white"}]
...
execute as @a[scores={switch_class=2}] run tellraw @s {"text":""}
execute as @a[scores={switch_class=2}] run tellraw @s ["",{"text":" ▸ ","color":"gold"},{"text":"行為獎勵: ","color":"yellow"},{"text":"擊殺敵人 +$10","color":"aqua"}]
execute as @a[scores={switch_class=2}] run tellraw @s ["",{"text":" ▸ ","color":"gold"},{"text":"固有投擲物: ","color":"yellow"},{"text":"擊殺後自動補充 ","color":"white"},{"text":"閃光彈/破片手榴彈","color":"aqua"}]
...
execute as @a[scores={switch_class=3}] run tellraw @s ["",{"text":"   效果: ","color":"gray"},{"text":"攜帶兩瓶補包：強化補包 + 一般補包。","color":"white"}]
execute as @a[scores={switch_class=3}] run tellraw @s {"text":""}
execute as @a[scores={switch_class=3}] run tellraw @s ["",{"text":" ▸ ","color":"gold"},{"text":"行為獎勵: ","color":"yellow"},{"text":"助攻 +$20","color":"aqua"}]
execute as @a[scores={switch_class=3}] run tellraw @s ["",{"text":" ▸ ","color":"gold"},{"text":"初始武器: ","color":"yellow"},{"text":"MAS-38 衝鋒槍","color":"white"}]
execute as @a[scores={switch_class=3}] run tellraw @s ["",{"text":" ▸ ","color":"gold"},{"text":"固有投擲物: ","color":"yellow"},{"text":"所有投擲物","color":"aqua"}]
...
execute as @a[scores={switch_class=4}] run tellraw @s {"text":""}
execute as @a[scores={switch_class=4}] run tellraw @s ["",{"text":" ▸ ","color":"gold"},{"text":"行為獎勵: ","color":"yellow"},{"text":"蹲下且靜止不動，每秒 +$1","color":"aqua"}]
execute as @a[scores={switch_class=4}] run tellraw @s ["",{"text":" ▸ ","color":"gold"},{"text":"初始武器: ","color":"yellow"},{"text":"M1895 左輪手槍","color":"white"}]
execute as @a[scores={switch_class=4}] run tellraw @s ["",{"text":" ▸ ","color":"gold"},{"text":"固有投擲物: ","color":"yellow"},{"text":"擊殺後自動補充 ","color":"white"},{"text":"煙霧彈/手榴彈/燃燒彈","color":"aqua"}]
...
# 1. 調整身體屬性 (血量)
execute as @a[scores={switch_class=5,pending_class=0..}] run function game_core:class/apply
# 2. 發放新職業的初始裝備
execute as @a[scores={switch_class=5,pending_class=0..}] run function game_core:class/give_gear
execute as @a[scores={switch_class=5,pending_class=0..}] run function game_core:class/reset_throwables
execute as @a[scores={switch_class=5,pending_class=0..}] run function game_core:class/give_ammo
