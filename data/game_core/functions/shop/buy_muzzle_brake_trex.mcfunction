# ==========================================
# 檔案: shop/buy_muzzle_brake_trex.mcfunction
# 觸發: 玩家把「假 T-Rex 重型槍口制退器」拿進背包的瞬間
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 T-Rex 重型制退器 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]