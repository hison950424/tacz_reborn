# ==========================================
# 檔案: shop/buy_sight_fastfire_pistol.mcfunction
# 觸發: 玩家把「假 FastFire 瞄準鏡」拿進背包的瞬間
# ==========================================

clear @s tacz:attachment{ShopItem:"sight_fastfire_pistol"}
...
give @s tacz:attachment{AttachmentId:"tacz:sight_fastfire_pistol"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 FastFire 瞄具 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]