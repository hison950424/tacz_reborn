# ==========================================
# 檔案: shop/buy_aug.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"aug"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:aug",GunFireMode:"AUTO"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 AUG ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]