# ==========================================
# 檔案: shop/buy_sight_deltapoint_pistol.mcfunction
# 觸發: 玩家把「假 DeltaPoint 瞄準鏡」拿進背包的瞬間
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 DeltaPoint 瞄具 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]