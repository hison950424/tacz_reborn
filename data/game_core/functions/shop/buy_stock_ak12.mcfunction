# ==========================================
# 檔案: shop/buy_stock_ak12.mcfunction
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 AK12 槍托 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]