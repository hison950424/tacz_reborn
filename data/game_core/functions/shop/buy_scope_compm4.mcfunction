# ==========================================
# 檔案: shop/buy_scope_compm4.mcfunction
# 觸發: 玩家把「假 CompM4 紅點瞄準鏡」拿進背包的瞬間
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 CompM4 紅點 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]