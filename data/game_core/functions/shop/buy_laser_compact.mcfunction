# ==========================================
# 檔案: shop/buy_laser_compact.mcfunction
# ==========================================
# 0. 沒收假物品 (無論有無 shop:1b)
...
tellraw @s ["",{"text":"[商店] 成功購買 Militech 緊湊雷射 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]