# ==========================================
# 檔案: shop/buy_rm277_silencer.mcfunction
# 觸發: 玩家把「假 RM277 滅音器」拿進背包的瞬間
# ==========================================

clear @s tacz:attachment{ShopItem:"rm277_silencer"}
...
give @s tacz:attachment{AttachmentId:"suffuse:rm277_silencer"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 RM277 滅音器 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]