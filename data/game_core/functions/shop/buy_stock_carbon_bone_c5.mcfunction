# ==========================================
# 檔案: shop/buy_stock_carbon_bone_c5.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_carbon_bone_c5"}
...
give @s tacz:attachment{AttachmentId:"tacz:stock_carbon_bone_c5"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Carbon bone C5 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]