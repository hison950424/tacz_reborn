...
gd656killicon server statistics add score @s -480
tellraw @s ["",{"text":"[商店] 成功購買 ar57 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]