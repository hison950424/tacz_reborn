# ==========================================
# 檔案: shop/buy_muzzle_brake_mastiff_sg.mcfunction
# 觸發: 玩家把「假 Mastiff 霰彈槍制退器」拿進背包的瞬間
# ==========================================

clear @s tacz:attachment{ShopItem:"muzzle_brake_mastiff_sg"}
...
give @s tacz:attachment{AttachmentId:"tacz:muzzle_brake_mastiff_sg"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Mastiff 霰彈制退器 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]