# ==========================================
# 檔案: shop/buy_cs2_karambit.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"cs2_karambit"}
...
give @s lrtactical:melee{MeleeWeaponId:"cs2_wt:karambit"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 CS2爪子刀 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]