# ==========================================
# 檔案: shop/buy_stock_vltor_emod_green.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_vltor_emod_green"}
...
give @s tacz:attachment{AttachmentId:"suffuse:stock_vltor_emod_green"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 VLTOR E-MOD 槍托 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]