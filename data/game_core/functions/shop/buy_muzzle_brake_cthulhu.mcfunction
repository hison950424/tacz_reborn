# ==========================================
# 檔案: shop/buy_muzzle_brake_cthulhu.mcfunction
# 觸發: 玩家把「假 Cthulhu K7 槍口制退器」拿進背包的瞬間
# ==========================================

clear @s tacz:attachment{ShopItem:"muzzle_brake_cthulhu"}
...
give @s tacz:attachment{AttachmentId:"tacz:muzzle_brake_cthulhu"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Cthulhu K7 制退器 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]