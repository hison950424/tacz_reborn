# ==========================================
# 檔案: shop/buy_scope_qlu11s.mcfunction
# 觸發: 玩家把「假 QLU-11 光電瞄準鏡」拿進背包的瞬間
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 QLU-11 光電瞄具 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]