...
tellraw @s ["",{"text":"[商店] 成功購買 RGN 衝擊手榴彈 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]