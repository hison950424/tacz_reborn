# ==========================================
# 檔案: shop/buy_muzzle_brake_pioneer.mcfunction
# 觸發: 玩家把「假 Pioneer A3 槍口制退器」拿進背包的瞬間
# ==========================================

# 0. 【核心防弊】瞬間沒收玩家剛從箱子裡拿到的「展示假物品」
clear @s tacz:attachment{ShopItem:"muzzle_brake_pioneer"}
...
# 5. 發放真正的配件、音效、扣款
give @s tacz:attachment{AttachmentId:"tacz:muzzle_brake_pioneer"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Pioneer 制退器 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]