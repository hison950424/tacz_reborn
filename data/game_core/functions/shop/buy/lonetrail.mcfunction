# ==========================================
# 檔案: shop/buy/lonetrail.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"lonetrail"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:lonetrail",GunFireMode:"SEMI"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Lonetrail ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
