# ==========================================
# 檔案: shop/buy/smoke_grenade.mcfunction
# ==========================================
clear @s lrtactical:throwable{ShopItem:"smoke_grenade"}
...
scoreboard players set @s shop_price 48
...
give @s lrtactical:throwable{ThrowableId:"lrtactical:smoke_grenade"} 1
execute at @s run playsound block.anvil.use master @s ~ ~ ~ 1 1.2
gd656killicon server statistics add score @s -48
tellraw @s ["",{"text":"[商店] 成功購買 M18 煙霧彈 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
