# ==========================================
# 檔案: shop/buy_sight_dbala2.mcfunction
# 觸發: 玩家把「假 DBAL-A2 戰術雷射」拿進背包的瞬間
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 DBAL-A2 戰術雷射 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]