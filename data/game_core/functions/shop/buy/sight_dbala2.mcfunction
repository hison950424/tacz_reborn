# ==========================================
# 檔案: shop/buy/sight_dbala2.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"sight_dbala2"}
...
give @s tacz:attachment{AttachmentId:"suffuse:sight_dbala2"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 DBAL-A2（瞄具槽） ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
