# ==========================================
# 檔案: shop/buy_m16a4.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"m16a4"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:m16a4",GunFireMode:"BURST"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 M16A4 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]