# ==========================================
# 檔案: shop/buy/m249.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"m249"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:m249",GunFireMode:"AUTO"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 M249 SAW ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
