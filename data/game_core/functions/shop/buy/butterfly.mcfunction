# ==========================================
# 檔案: shop/buy_butterfly.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"butterfly"}
...
give @s lrtactical:melee{MeleeWeaponId:"cs2_wt:butterfly"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 蝴蝶刀 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]