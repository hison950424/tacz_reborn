# ==========================================
# 檔案: shop/buy/sight_exp3.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"sight_exp3"}
...
give @s tacz:attachment{AttachmentId:"tacz:sight_exp3"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 EXP3 全息 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
