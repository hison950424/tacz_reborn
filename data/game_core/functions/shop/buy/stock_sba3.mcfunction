# ==========================================
# 檔案: shop/buy/stock_sba3.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_sba3"}
...
give @s tacz:attachment{AttachmentId:"tacz:stock_sba3"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 SBA3 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
