...
give @s tacz:modern_kinetic_gun{GunId:"tacz:b93r",GunFireMode:"AUTO"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 B93R ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
