# ==========================================
# 檔案: shop/buy/rgn.mcfunction
# ==========================================
clear @s lrtactical:throwable{ShopItem:"rgn"}
...
scoreboard players set @s shop_price 64
...
give @s lrtactical:throwable{ThrowableId:"lrtactical:rgn"} 1
execute at @s run playsound block.anvil.use master @s ~ ~ ~ 1 1.2
gd656killicon server statistics add score @s -64
tellraw @s ["",{"text":"[商店] 成功購買 RGN 手榴彈 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
