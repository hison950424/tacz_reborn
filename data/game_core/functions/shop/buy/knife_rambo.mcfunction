# ==========================================
# 檔案: shop/buy/knife_rambo.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"knife_rambo"}
...
give @s lrtactical:melee{MeleeWeaponId:"suffuse:knife_rambo"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 藍波刀 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
