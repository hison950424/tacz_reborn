# ==========================================
# 檔案: shop/buy/iron_boots.mcfunction
# ==========================================
clear @s minecraft:iron_boots{ShopItem:"iron_boots"}
...
give @s minecraft:iron_boots{Unbreakable:1b} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 鐵靴子 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
