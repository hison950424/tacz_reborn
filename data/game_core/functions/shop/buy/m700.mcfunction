# ==========================================
# 檔案: shop/buy/m700.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"m700"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:m700",GunFireMode:"SEMI"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 M700 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
