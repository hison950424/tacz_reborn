# ==========================================
# 檔案: shop/buy/kar98.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"kar98"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:kar98",GunFireMode:"SEMI"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Kar98k ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
