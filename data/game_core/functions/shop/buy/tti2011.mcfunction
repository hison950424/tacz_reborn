# ==========================================
# 檔案: shop/buy/tti2011.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"tti2011"}
...
give @s tacz:modern_kinetic_gun{GunId:"suffuse:tti2011",GunFireMode:"SEMI"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 TTI 2011 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
