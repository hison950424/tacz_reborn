# ==========================================
# 檔案: shop/buy/push.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"push"}
...
give @s lrtactical:melee{MeleeWeaponId:"cs2_wt:push"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 推刀 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
