# ==========================================
# 檔案: shop/buy/sight_t2.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"sight_t2"}
...
give @s tacz:attachment{AttachmentId:"tacz:sight_t2"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 T2 紅點 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
