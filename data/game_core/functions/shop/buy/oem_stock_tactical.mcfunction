# ==========================================
# 檔案: shop/buy/oem_stock_tactical.mcfunction
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 原廠戰術 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
