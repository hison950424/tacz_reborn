# ==========================================
# 檔案: shop/buy_oem_stock_tactical.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"oem_stock_tactical"}
...
give @s tacz:attachment{AttachmentId:"tacz:oem_stock_tactical"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 原廠戰術槍托 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]