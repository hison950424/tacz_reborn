# ==========================================
# 檔案: shop/buy/sniper_extended_mag_1.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"sniper_extended_mag_1"}
...
give @s tacz:attachment{AttachmentId:"tacz:sniper_extended_mag_1"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 狙擊彈匣 I ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
