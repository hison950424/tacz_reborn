# ==========================================
# 檔案: shop/buy/grip_rk6.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"grip_rk6"}
...
give @s tacz:attachment{AttachmentId:"tacz:grip_rk6"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 RK-6 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
