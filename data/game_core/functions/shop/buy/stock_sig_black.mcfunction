# ==========================================
# 檔案: shop/buy/stock_sig_black.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_sig_black"}
...
give @s tacz:attachment{AttachmentId:"suffuse:stock_sig_black"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 SIG 戰術黑 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
