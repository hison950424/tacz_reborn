# ==========================================
# 檔案: shop/buy/muzzle_brake_trex.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"muzzle_brake_trex"}
...
give @s tacz:attachment{AttachmentId:"tacz:muzzle_brake_trex"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 T-Rex 重型 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
