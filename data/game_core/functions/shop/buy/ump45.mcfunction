# ==========================================
# 檔案: shop/buy/ump45.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"ump45"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:ump45",GunFireMode:"AUTO"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 UMP-45 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
