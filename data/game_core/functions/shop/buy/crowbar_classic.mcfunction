# ==========================================
# 檔案: shop/buy/crowbar_classic.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"crowbar_classic"}
...
give @s lrtactical:melee{MeleeWeaponId:"suffuse:crowbar_classic"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 撬棍 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
