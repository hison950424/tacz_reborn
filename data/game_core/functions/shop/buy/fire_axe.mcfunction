# ==========================================
# 檔案: shop/buy/fire_axe.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"fire_axe"}
...
give @s lrtactical:melee{MeleeWeaponId:"suffuse:fire_axe"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 消防斧 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
