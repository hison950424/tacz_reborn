# ==========================================
# 檔案: shop/buy/m9_knife.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"m9_knife"}
...
give @s lrtactical:melee{MeleeWeaponId:"cs2_wt:m9"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 M9 刺刀 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
