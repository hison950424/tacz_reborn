# ==========================================
# 檔案: shop/buy/flash_shield.mcfunction
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 防彈閃光盾 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
