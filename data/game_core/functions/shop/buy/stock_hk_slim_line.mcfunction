# ==========================================
# 檔案: shop/buy/stock_hk_slim_line.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_hk_slim_line"}
...
give @s tacz:attachment{AttachmentId:"tacz:stock_hk_slim_line"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 HK 薄身版 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
