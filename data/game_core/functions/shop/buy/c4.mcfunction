# ==========================================
# 檔案: shop/buy/c4.mcfunction
# ==========================================
clear @s lrtactical:throwable{ShopItem:"c4"}
...
scoreboard players set @s shop_price 96
...
give @s lrtactical:throwable{ThrowableId:"lrtactical:c4"} 1
execute at @s run playsound block.anvil.use master @s ~ ~ ~ 1 1.2
gd656killicon server statistics add score @s -96
tellraw @s ["",{"text":"[商店] 成功購買 C4 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
