# ==========================================
# 檔案: shop/buy/ammo_mod_he.mcfunction
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 高爆彈 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
