# ==========================================
# 檔案: shop/buy/grip_td_black.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"grip_td_black"}
...
give @s tacz:attachment{AttachmentId:"suffuse:grip_td_black"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 TD 快拆 黑色 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
