# ==========================================
# 檔案: shop/buy/extended_mag_1.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"extended_mag_1"}
...
give @s tacz:attachment{AttachmentId:"tacz:extended_mag_1"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 重型彈匣 I ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
