# ==========================================
# 檔案: shop/buy/light_extended_mag_1.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"light_extended_mag_1"}
...
give @s tacz:attachment{AttachmentId:"tacz:light_extended_mag_1"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 輕型彈匣 I ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
