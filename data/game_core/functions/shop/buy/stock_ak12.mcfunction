# ==========================================
# 檔案: shop/buy/stock_ak12.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_ak12"}
...
give @s tacz:attachment{AttachmentId:"tacz:stock_ak12"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 AK12 標準 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
