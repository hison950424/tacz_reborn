# ==========================================
# 檔案: shop/buy_qbz_95.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"qbz_95"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:qbz_95",GunFireMode:"AUTO"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 QBZ-95 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]