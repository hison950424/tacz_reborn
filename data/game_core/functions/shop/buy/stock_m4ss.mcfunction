# ==========================================
# 檔案: shop/buy_stock_m4ss.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_m4ss"}
...
give @s tacz:attachment{AttachmentId:"tacz:stock_m4ss"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 M4SS 槍托 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]