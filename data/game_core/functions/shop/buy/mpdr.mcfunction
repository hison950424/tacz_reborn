# ==========================================
# 檔案: shop/buy_mpdr.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"mpdr"}
...
give @s tacz:modern_kinetic_gun{GunId:"suffuse:mpdr",GunFireMode:"AUTO"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 MPDR ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]