# ==========================================
# 檔案: shop/buy/m24.mcfunction
# ==========================================
clear @s lrtactical:throwable{ShopItem:"m24"}
...
give @s lrtactical:throwable{ThrowableId:"suffuse:m24"} 1
execute at @s run playsound block.anvil.use master @s ~ ~ ~ 1 1.2
gd656killicon server statistics add score @s -64
tellraw @s ["",{"text":"[商店] 成功購買 柄式手榴彈 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
