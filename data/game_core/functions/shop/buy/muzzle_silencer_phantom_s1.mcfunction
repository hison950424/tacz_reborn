# ==========================================
# 檔案: shop/buy_muzzle_silencer_phantom_s1.mcfunction
# 觸發: 玩家把「假 Phantom S1 滅音器」拿進背包的瞬間
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 Phantom S1 滅音器 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]