# ==========================================
# 檔案: shop/buy/laser_compact.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"laser_compact"}
...
give @s tacz:attachment{AttachmentId:"tacz:laser_compact"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Militech 緊湊型 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
