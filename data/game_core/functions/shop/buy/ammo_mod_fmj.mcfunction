# ==========================================
# 檔案: shop/buy/ammo_mod_fmj.mcfunction
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 全金屬被甲 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
