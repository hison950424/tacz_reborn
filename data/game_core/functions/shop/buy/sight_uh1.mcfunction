# ==========================================
# 檔案: shop/buy/sight_uh1.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"sight_uh1"}
...
give @s tacz:attachment{AttachmentId:"tacz:sight_uh1"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 UH-1 全息 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
