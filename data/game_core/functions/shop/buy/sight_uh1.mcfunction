# ==========================================
# 檔案: shop/buy_sight_uh1.mcfunction
# 觸發: 玩家把「假 UH-1 全息瞄準鏡」拿進背包的瞬間
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 UH-1 全息瞄具 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]