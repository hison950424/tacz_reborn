# ==========================================
# 檔案: shop/buy/db_short.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"db_short"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:db_short",GunFireMode:"SEMI"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 雙管短槍 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
