# ==========================================
# 檔案: shop/buy/scope_acog_ta31.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"scope_acog_ta31"}
...
give @s tacz:attachment{AttachmentId:"tacz:scope_acog_ta31"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 ACOG TA31 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
