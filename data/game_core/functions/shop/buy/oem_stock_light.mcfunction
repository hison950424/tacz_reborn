# ==========================================
# 檔案: shop/buy/oem_stock_light.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"oem_stock_light"}
...
give @s tacz:attachment{AttachmentId:"tacz:oem_stock_light"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 原廠輕型 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
