# ==========================================
# 檔案: shop/buy/grip_se_5.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"grip_se_5"}
...
give @s tacz:attachment{AttachmentId:"tacz:grip_se_5"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 SE-5 前握把 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
