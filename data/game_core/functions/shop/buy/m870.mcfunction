# ==========================================
# 檔案: shop/buy_m870.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"m870"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:m870",GunFireMode:"SEMI"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 m870 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]