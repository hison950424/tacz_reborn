# ==========================================
# 檔案: shop/buy/muzzle_silencer_ptilopsis.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"muzzle_silencer_ptilopsis"}
...
give @s tacz:attachment{AttachmentId:"tacz:muzzle_silencer_ptilopsis"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 PO-2 白頭角鴞 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
