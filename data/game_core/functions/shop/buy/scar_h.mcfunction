...
execute if score @s class_type matches 1 run scoreboard players set @s shop_price 440
...
execute if score @s class_type matches 1 run gd656killicon server statistics add score @s -440
execute unless score @s class_type matches 1 run gd656killicon server statistics add score @s -550
