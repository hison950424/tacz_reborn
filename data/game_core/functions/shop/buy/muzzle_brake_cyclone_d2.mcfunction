# ==========================================
# 檔案: shop/buy/muzzle_brake_cyclone_d2.mcfunction
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 Cyclone D2 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
