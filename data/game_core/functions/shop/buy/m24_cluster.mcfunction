# ==========================================
# 檔案: shop/buy/m24_cluster.mcfunction
# ==========================================
clear @s lrtactical:throwable{ShopItem:"m24_cluster"}
...
give @s lrtactical:throwable{ThrowableId:"suffuse:m24_cluster"} 1
execute at @s run playsound block.anvil.use master @s ~ ~ ~ 1 1.2
gd656killicon server statistics add score @s -160
tellraw @s ["",{"text":"[商店] 成功購買 集束手榴彈 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
