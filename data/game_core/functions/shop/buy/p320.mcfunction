# ==========================================
# 檔案: shop/buy/p320.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"p320"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:p320",GunFireMode:"SEMI"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 SIG P320 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
