# ==========================================
# 檔案: shop/buy/diamond_leggings.mcfunction
# ==========================================
clear @s minecraft:diamond_leggings{ShopItem:"diamond_leggings"}
...
give @s minecraft:diamond_leggings{Unbreakable:1b} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 鑽石護腿 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
