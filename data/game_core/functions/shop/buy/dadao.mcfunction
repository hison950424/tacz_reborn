# ==========================================
# 檔案: shop/buy/dadao.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"dadao"}
...
give @s lrtactical:melee{MeleeWeaponId:"suffuse:dadao"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 大刀 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
