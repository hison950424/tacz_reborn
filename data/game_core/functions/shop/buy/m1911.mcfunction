# ==========================================
# 檔案: shop/buy/m1911.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"m1911"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:m1911",GunFireMode:"SEMI"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 M1911 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
