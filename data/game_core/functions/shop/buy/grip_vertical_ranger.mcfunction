# ==========================================
# 檔案: shop/buy/grip_vertical_ranger.mcfunction
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 Koch 遊騎兵重型 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
