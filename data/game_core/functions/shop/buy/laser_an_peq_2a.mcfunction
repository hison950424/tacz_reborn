# ==========================================
# 檔案: shop/buy/laser_an_peq_2a.mcfunction
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 AN/PEQ-2A ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
