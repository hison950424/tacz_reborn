# ==========================================
# 檔案: shop/buy/grip_m203.mcfunction
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 M203 榴彈發射器 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
