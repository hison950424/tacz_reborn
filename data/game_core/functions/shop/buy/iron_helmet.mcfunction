# ==========================================
# 檔案: shop/buy/iron_helmet.mcfunction
# ==========================================
clear @s minecraft:iron_helmet{ShopItem:"iron_helmet"}
...
give @s minecraft:iron_helmet{Unbreakable:1b} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 鐵頭盔 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
