# ==========================================
# 檔案: shop/buy/grip_cobra.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"grip_cobra"}
...
give @s tacz:attachment{AttachmentId:"tacz:grip_cobra"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 SI 握把 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
