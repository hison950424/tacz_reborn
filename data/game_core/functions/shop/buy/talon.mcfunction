# ==========================================
# 檔案: shop/buy/talon.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"talon"}
...
give @s lrtactical:melee{MeleeWeaponId:"cs2_wt:talon"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 利爪刀 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
