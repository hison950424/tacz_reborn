# ==========================================
# 檔案: shop/buy/grip_bt10vbatlas.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"grip_bt10vbatlas"}
...
give @s tacz:attachment{AttachmentId:"suffuse:grip_bt10vbatlas"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 BT10 摺疊腳架 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
