# ==========================================
# 檔案: shop/buy/shotgun_extended_mag_2.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"shotgun_extended_mag_2"}
...
give @s tacz:attachment{AttachmentId:"tacz:shotgun_extended_mag_2"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 霰彈彈匣 II ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
