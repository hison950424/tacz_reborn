# ==========================================
# 檔案: shop/buy_stock_elf_ultralight.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_elf_ultralight"}
...
give @s tacz:attachment{AttachmentId:"suffuse:stock_elf_ultralight"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 ELF 超輕槍托 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]