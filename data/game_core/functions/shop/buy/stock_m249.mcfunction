# ==========================================
# 檔案: shop/buy/stock_m249.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_m249"}
...
give @s tacz:attachment{AttachmentId:"suffuse:stock_m249"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 M249 傘兵伸縮 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
