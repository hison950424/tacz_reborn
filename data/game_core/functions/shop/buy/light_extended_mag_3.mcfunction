# ==========================================
# 檔案: shop/buy/light_extended_mag_3.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"light_extended_mag_3"}
...
give @s tacz:attachment{AttachmentId:"tacz:light_extended_mag_3"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 輕型彈匣 III ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
