# ==========================================
# 檔案: shop/buy_sks_tactical.mcfunction
# 備註: 單發點射步槍
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"sks_tactical"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:sks_tactical",GunFireMode:"SEMI"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 SKS 戰術版 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]