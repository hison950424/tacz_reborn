# ==========================================
# 檔案: shop/buy/stock_moe.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_moe"}
...
give @s tacz:attachment{AttachmentId:"tacz:stock_moe"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Magpul MOE ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
