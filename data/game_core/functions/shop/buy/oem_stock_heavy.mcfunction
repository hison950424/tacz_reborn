# ==========================================
# 檔案: shop/buy/oem_stock_heavy.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"oem_stock_heavy"}
...
give @s tacz:attachment{AttachmentId:"tacz:oem_stock_heavy"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 原廠重型 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
