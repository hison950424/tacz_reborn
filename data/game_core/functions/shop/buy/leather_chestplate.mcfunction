# ==========================================
# 檔案: shop/buy/leather_chestplate.mcfunction
# ==========================================
clear @s minecraft:leather_chestplate{ShopItem:"leather_chestplate"}
...
give @s minecraft:leather_chestplate{Unbreakable:1b} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 皮革胸甲 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
