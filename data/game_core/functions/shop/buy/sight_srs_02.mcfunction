# ==========================================
# 檔案: shop/buy/sight_srs_02.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"sight_srs_02"}
...
give @s tacz:attachment{AttachmentId:"tacz:sight_srs_02"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 SRS-02 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
