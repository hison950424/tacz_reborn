# ==========================================
# 檔案: shop/buy_sniper_extended_mag_2.mcfunction
# 觸發: 玩家把「假 2級狙擊擴容彈匣」拿進背包的瞬間
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 2級狙擊擴容彈匣 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]