# ==========================================
# 檔案: shop/buy/muzzle_silencer_vulture.mcfunction
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 Vulture .50 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
