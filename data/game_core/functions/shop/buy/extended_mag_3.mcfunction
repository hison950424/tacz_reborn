# ==========================================
# 檔案: shop/buy/extended_mag_3.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"extended_mag_3"}
...
give @s tacz:attachment{AttachmentId:"tacz:extended_mag_3"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 重型彈匣 III ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
