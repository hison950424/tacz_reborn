# ==========================================
# 檔案: shop/buy/stock_bcm_mod2_sopmod.mcfunction
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 BCM MOD2 SOPMOD ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
