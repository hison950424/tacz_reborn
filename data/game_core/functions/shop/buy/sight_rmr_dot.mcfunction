# ==========================================
# 檔案: shop/buy/sight_rmr_dot.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"sight_rmr_dot"}
...
give @s tacz:attachment{AttachmentId:"tacz:sight_rmr_dot"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 RMR 迷你紅點 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
