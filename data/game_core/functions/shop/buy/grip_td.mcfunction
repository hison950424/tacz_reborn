# ==========================================
# 檔案: shop/buy/grip_td.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"grip_td"}
...
give @s tacz:attachment{AttachmentId:"tacz:grip_td"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 TD 握把 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
