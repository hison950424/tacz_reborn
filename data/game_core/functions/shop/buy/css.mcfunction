# ==========================================
# 檔案: shop/buy/css.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"css"}
...
give @s lrtactical:melee{MeleeWeaponId:"cs2_wt:css"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 CSS 折刀 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
