# ==========================================
# 檔案: shop/buy/laser_lopro.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"laser_lopro"}
...
give @s tacz:attachment{AttachmentId:"tacz:laser_lopro"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Lopro 戰術型 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
