# ==========================================
# 檔案: shop/buy_scope_1873_6x.mcfunction
# 觸發: 玩家把「假 老式春田步槍瞄鏡」拿進背包的瞬間
# ==========================================

clear @s tacz:attachment{ShopItem:"scope_1873_6x"}
...
give @s tacz:attachment{AttachmentId:"tacz:scope_1873_6x"} 1
execute at @s run playsound block.anvil.use master @s ~ ~ ~ 1 1.2
gd656killicon server statistics add score @s -300
tellraw @s ["",{"text":"[商店] 成功購買 老式春田瞄具 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]