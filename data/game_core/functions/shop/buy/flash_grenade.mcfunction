# ==========================================
# 檔案: shop/buy/flash_grenade.mcfunction
# ==========================================
clear @s lrtactical:throwable{ShopItem:"flash_grenade"}
...
give @s lrtactical:throwable{ThrowableId:"lrtactical:flash_grenade"} 1
execute at @s run playsound block.anvil.use master @s ~ ~ ~ 1 1.2
gd656killicon server statistics add score @s -48
tellraw @s ["",{"text":"[商店] 成功購買 閃光彈 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
