# ==========================================
# 檔案: shop/buy/mg338_silencer.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"mg338_silencer"}
...
give @s tacz:attachment{AttachmentId:"suffuse:mg338_silencer"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 MG338 消音器 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
