# ==========================================
# 檔案: shop/buy/scope_vudu.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"scope_vudu"}
...
give @s tacz:attachment{AttachmentId:"tacz:scope_vudu"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Vudu 1-6x ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
