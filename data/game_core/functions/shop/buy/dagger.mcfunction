# ==========================================
# 檔案: shop/buy/dagger.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"dagger"}
...
give @s lrtactical:melee{MeleeWeaponId:"lrtactical:dagger"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 匕首 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
