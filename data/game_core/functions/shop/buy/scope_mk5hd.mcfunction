# ==========================================
# 檔案: shop/buy/scope_mk5hd.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"scope_mk5hd"}
...
give @s tacz:attachment{AttachmentId:"tacz:scope_mk5hd"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Mark 5 HD 5-25x ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
