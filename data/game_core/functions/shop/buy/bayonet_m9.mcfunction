# ==========================================
# 檔案: shop/buy/bayonet_m9.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"bayonet_m9"}
...
give @s tacz:attachment{AttachmentId:"tacz:bayonet_m9"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 M9 刺刀（膛口） ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
