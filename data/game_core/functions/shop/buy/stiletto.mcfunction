# ==========================================
# 檔案: shop/buy/stiletto.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"stiletto"}
...
give @s lrtactical:melee{MeleeWeaponId:"cs2_wt:stiletto"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 細刃刀 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
