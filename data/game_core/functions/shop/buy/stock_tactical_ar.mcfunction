# ==========================================
# 檔案: shop/buy/stock_tactical_ar.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_tactical_ar"}
...
give @s tacz:attachment{AttachmentId:"tacz:stock_tactical_ar"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Magpul CTR ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
