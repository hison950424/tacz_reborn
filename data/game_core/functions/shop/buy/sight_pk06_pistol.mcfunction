# ==========================================
# 檔案: shop/buy_sight_pk06_pistol.mcfunction
# 觸發: 玩家把「假 PK06 反射式瞄準鏡」拿進背包的瞬間
# ==========================================

clear @s tacz:attachment{ShopItem:"sight_pk06_pistol"}
...
give @s tacz:attachment{AttachmentId:"tacz:sight_pk06_pistol"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 PK06 瞄具 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]