# ==========================================
# 檔案: shop/buy/laser_peq6.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"laser_peq6"}
...
give @s tacz:attachment{AttachmentId:"tacz:laser_peq6"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 PEQ-6 戰術燈+雷射 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
