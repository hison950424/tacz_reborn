# ==========================================
# 檔案: shop/buy/skeleton.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"skeleton"}
...
give @s lrtactical:melee{MeleeWeaponId:"cs2_wt:skeleton"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 骷髏刀 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
