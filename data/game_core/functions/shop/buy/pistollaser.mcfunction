# ==========================================
# 檔案: shop/buy/pistollaser.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"pistollaser"}
...
give @s tacz:attachment{AttachmentId:"suffuse:pistollaser"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 手槍雷射（裝備槽） ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
