# ==========================================
# 檔案: shop/buy/tec9.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"tec9"}
...
give @s tacz:modern_kinetic_gun{GunId:"suffuse:tec9",GunFireMode:"AUTO"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Tec-9 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
