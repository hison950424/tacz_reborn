# ==========================================
# 檔案: shop/buy/qsz92g.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"qsz92g"}
...
give @s tacz:modern_kinetic_gun{GunId:"suffuse:qsz92g",GunFireMode:"SEMI"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 QSZ-92G ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
