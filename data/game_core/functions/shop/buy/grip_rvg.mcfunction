# ==========================================
# 檔案: shop/buy/grip_rvg.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"grip_rvg"}
...
give @s tacz:attachment{AttachmentId:"suffuse:grip_rvg"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Magpul RVG ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
