# ==========================================
# 檔案: shop/buy/bayonet_knife.mcfunction
# ==========================================
clear @s lrtactical:melee{ShopItem:"bayonet_knife"}
...
give @s lrtactical:melee{MeleeWeaponId:"cs2_wt:bayonet"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 刺刀 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
