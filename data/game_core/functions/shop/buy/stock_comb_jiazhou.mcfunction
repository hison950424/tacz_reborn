# ==========================================
# 檔案: shop/buy/stock_comb_jiazhou.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_comb_jiazhou"}
...
give @s tacz:attachment{AttachmentId:"suffuse:stock_comb_jiazhou"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 甲胄 95式托腮板 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
