# ==========================================
# 檔案: shop/buy/leather_boots.mcfunction
# ==========================================
clear @s minecraft:leather_boots{ShopItem:"leather_boots"}
...
give @s minecraft:leather_boots{Unbreakable:1b} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 皮革靴子 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
