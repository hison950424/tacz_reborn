# ==========================================
# 檔案: shop/buy/iron_leggings.mcfunction
# ==========================================
clear @s minecraft:iron_leggings{ShopItem:"iron_leggings"}
...
give @s minecraft:iron_leggings{Unbreakable:1b} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 鐵護腿 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
