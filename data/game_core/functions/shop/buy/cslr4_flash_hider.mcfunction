# ==========================================
# 檔案: shop/buy/cslr4_flash_hider.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"cslr4_flash_hider"}
...
give @s tacz:attachment{AttachmentId:"suffuse:cslr4_flash_hider"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 CS/LR4 消焰器 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
