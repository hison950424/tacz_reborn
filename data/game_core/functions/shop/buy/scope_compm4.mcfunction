# ==========================================
# 檔案: shop/buy/scope_compm4.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"scope_compm4"}
...
give @s tacz:attachment{AttachmentId:"suffuse:scope_compm4"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Aimpoint CompM4 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]
