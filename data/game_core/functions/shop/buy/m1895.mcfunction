# ==========================================
# 檔案: shop/buy_m1895.mcfunction
# 備註: 手動拉栓步槍
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"m1895"}
...
give @s tacz:modern_kinetic_gun{GunId:"suffuse:m1895",GunFireMode:"SEMI"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 M1895 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]