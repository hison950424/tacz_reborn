# ==========================================
# 檔案: shop/buy_sight_552.mcfunction
# 觸發: 玩家把「假 Militech 552 全息瞄準鏡」拿進背包的瞬間
# ==========================================

clear @s tacz:attachment{ShopItem:"sight_552"}
...
give @s tacz:attachment{AttachmentId:"tacz:sight_552"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 552 全息瞄具 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]