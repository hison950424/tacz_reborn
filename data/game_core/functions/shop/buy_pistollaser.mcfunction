# ==========================================
# 檔案: shop/buy_pistollaser.mcfunction
# 說明: 處理 手槍雷射 的購買邏輯
# ==========================================
# 0. 【核心防弊】沒收假物品
...
tellraw @s ["",{"text":"[商店] 成功購買 手槍雷射 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]