...
execute if score #sync_val temp_score matches 500.. run scoreboard players remove @s gd656killicon.score 500
...
execute if score #sync_val temp_score matches 500.. run scoreboard players remove @s gd656killicon.score 50
...
execute if score #sync_val temp_score matches 500.. run scoreboard players remove @s gd656killicon.score 5
...
execute if score #sync_val temp_score matches 500.. run scoreboard players remove @s gd656killicon.score 1
