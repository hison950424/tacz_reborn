# ==========================================
# 檔案: shop/buy_laser_an_peq_2a.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"laser_an_peq_2a"}
...
give @s tacz:attachment{AttachmentId:"suffuse:laser_an_peq_2a"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 AN/PEQ-2A 雷射 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]