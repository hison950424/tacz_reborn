# ==========================================
# 檔案: shop/buy_qbz951.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"qbz951"}
...
give @s tacz:modern_kinetic_gun{GunId:"suffuse:qbz951",GunFireMode:"AUTO"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 QBZ-95-1 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]