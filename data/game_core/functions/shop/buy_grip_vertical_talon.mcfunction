# ==========================================
# 檔案: shop/buy_grip_vertical_talon.mcfunction
# 說明: 處理 Talon SG2 握把 的購買邏輯
# ==========================================
# 0. 【核心防弊】沒收假物品
clear @s tacz:attachment{ShopItem:"grip_vertical_talon"}
...
# 5. 【發放與扣款】
give @s tacz:attachment{AttachmentId:"tacz:grip_vertical_talon"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Talon SG2 握把 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]