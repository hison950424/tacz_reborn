# ==========================================
# 檔案: shop/buy_laser_nightstick.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"laser_nightstick"}
...
give @s tacz:attachment{AttachmentId:"tacz:laser_nightstick"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Nightstick 緊湊雷射 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]