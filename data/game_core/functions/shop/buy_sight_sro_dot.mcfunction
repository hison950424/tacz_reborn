# ==========================================
# 檔案: shop/buy_sight_sro_dot.mcfunction
# 觸發: 玩家把「假 SRO 迷你紅點瞄準鏡」拿進背包的瞬間
# ==========================================

clear @s tacz:attachment{ShopItem:"sight_sro_dot"}
...
give @s tacz:attachment{AttachmentId:"tacz:sight_sro_dot"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 SRO 迷你紅點 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]