# ==========================================
# 檔案: shop/buy_grip_vertical_military.mcfunction
# 說明: 處理 Nagoma 軍用標準握把 的購買邏輯
# ==========================================
# 0. 【核心防弊】沒收假物品
...
tellraw @s ["",{"text":"[商店] 成功購買 Nagoma 軍用握把 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]