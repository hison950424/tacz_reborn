# ==========================================
# 檔案: shop/buy_ammo_mod_hp.mcfunction
# 觸發: 玩家把「假 空尖彈」拿進背包的瞬間
# ==========================================

# 0. 【核心防弊】瞬間沒收玩家剛從箱子裡拿到的「展示假物品」
clear @s tacz:attachment{ShopItem:"ammo_mod_hp"}
...
# 5. 發放真正的配件、音效、扣款
give @s tacz:attachment{AttachmentId:"tacz:ammo_mod_hp"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 空尖彈(HP) ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]