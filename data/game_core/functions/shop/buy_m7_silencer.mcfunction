# ==========================================
# 檔案: shop/buy_m7_silencer.mcfunction
# 觸發: 玩家把「假 M7 滅音器」拿進背包的瞬間
# ==========================================

clear @s tacz:attachment{ShopItem:"m7_silencer"}
...
give @s tacz:attachment{AttachmentId:"suffuse:m7_silencer"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 M7 滅音器 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]