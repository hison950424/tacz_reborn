# ==========================================
# 檔案: shop/buy_muzzle_brake_timeless50.mcfunction
# 觸發: 玩家把「假 Timeless .50 制退器」拿進背包的瞬間
# ==========================================

clear @s tacz:attachment{ShopItem:"muzzle_brake_timeless50"}
...
give @s tacz:attachment{AttachmentId:"tacz:muzzle_brake_timeless50"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Timeless .50 制退器 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]