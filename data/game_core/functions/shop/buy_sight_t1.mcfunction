# ==========================================
# 檔案: shop/buy_sight_t1.mcfunction
# 觸發: 玩家把「假 T1 紅點瞄準鏡」拿進背包的瞬間
# ==========================================

clear @s tacz:attachment{ShopItem:"sight_t1"}
...
give @s tacz:attachment{AttachmentId:"tacz:sight_t1"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 T1 紅點 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]