# ==========================================
# 檔案: shop/buy_stock_sig_blue_grey.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_sig_blue_grey"}
...
give @s tacz:attachment{AttachmentId:"suffuse:stock_sig_blue_grey"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 SIG 槍托(灰藍) ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]