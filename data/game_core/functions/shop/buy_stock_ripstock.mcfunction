# ==========================================
# 檔案: shop/buy_stock_ripstock.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_ripstock"}
...
give @s tacz:attachment{AttachmentId:"tacz:stock_ripstock"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 RipStock 槍托 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]