# ==========================================
# 檔案: shop/buy_scope_standard_8x.mcfunction
# 觸發: 玩家把「假 斥候 4-10倍 瞄準鏡」拿進背包的瞬間
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 斥候 4-10x 狙擊鏡 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]