# ==========================================
# 檔案: shop/buy_grip_m203.mcfunction
# 說明: 處理 M203 下掛握把 的購買邏輯
# ==========================================
# 0. 【核心防弊】沒收假物品
clear @s tacz:attachment{ShopItem:"grip_m203"}
...
# 5. 【發放與扣款】
give @s tacz:attachment{AttachmentId:"suffuse:grip_m203"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 M203 握把 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]