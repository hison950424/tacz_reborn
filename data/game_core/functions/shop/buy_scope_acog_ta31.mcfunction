# ==========================================
# 檔案: shop/buy_scope_acog_ta31.mcfunction
# 觸發: 玩家把「假 TA31 2x 瞄具」拿進背包的瞬間
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 TA31 ACOG ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]