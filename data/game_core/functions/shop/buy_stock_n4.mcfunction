# ==========================================
# 檔案: shop/buy_stock_n4.mcfunction
# ==========================================
clear @s tacz:attachment{ShopItem:"stock_n4"}
...
give @s tacz:attachment{AttachmentId:"suffuse:stock_n4"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 MOE-SL-K 槍托 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]