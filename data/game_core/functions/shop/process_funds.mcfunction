...
execute if score @s gd656killicon.score < @s transfer_val run function game_core:shop/cancel
...
execute as @a[tag=confirm_target,limit=1] run function game_core:shop/cancel
...
function game_core:shop/cancel