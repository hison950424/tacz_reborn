# ==========================================
# 檔案: shop/buy_scope_mk5hd.mcfunction
# 觸發: 玩家把「假 Mark 5 HD 5-25x 瞄鏡」拿進背包的瞬間
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 Mark 5 HD 狙擊鏡 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]