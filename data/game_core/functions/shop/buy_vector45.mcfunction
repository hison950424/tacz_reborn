# ==========================================
# 檔案: shop/buy_vector45.mcfunction
# ==========================================
...
gd656killicon server statistics add score @s -500
tellraw @s ["",{"text":"[商店] 成功購買 vector45 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]