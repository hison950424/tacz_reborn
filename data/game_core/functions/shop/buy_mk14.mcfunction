# ==========================================
# 檔案: shop/buy_mk14.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"mk14"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:mk14",GunFireMode:"AUTO"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 MK14 EBR ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]