# ==========================================
# 檔案: shop/buy_bayonet_6h3.mcfunction
# 觸發: 玩家把「假 6H3刺刀」拿進背包的瞬間
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 6H3刺刀 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]