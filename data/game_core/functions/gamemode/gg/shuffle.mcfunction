...
summon marker ~ ~ ~ {Tags:["gg_cat_pool","gg_c7"]}
summon marker ~ ~ ~ {Tags:["gg_cat_pool","gg_c8"]}
summon marker ~ ~ ~ {Tags:["gg_cat_pool","gg_c9"]}
...
execute as @e[tag=gg_c7,limit=1] run scoreboard players set @s gg_config 7
execute as @e[tag=gg_c8,limit=1] run scoreboard players set @s gg_config 8
execute as @e[tag=gg_c9,limit=1] run scoreboard players set @s gg_config 9
...
tag @e[tag=gg_cat_pool,tag=!gg_used,sort=random,limit=1] add gg_sel
execute as @e[tag=gg_sel] run scoreboard players operation #gg_cat_order_7 gg_config = @s gg_config
tag @e[tag=gg_sel] add gg_used
tag @e[tag=gg_sel] remove gg_sel

tag @e[tag=gg_cat_pool,tag=!gg_used,sort=random,limit=1] add gg_sel
execute as @e[tag=gg_sel] run scoreboard players operation #gg_cat_order_8 gg_config = @s gg_config
tag @e[tag=gg_sel] add gg_used
tag @e[tag=gg_sel] remove gg_sel

tag @e[tag=gg_cat_pool,tag=!gg_used,sort=random,limit=1] add gg_sel
execute as @e[tag=gg_sel] run scoreboard players operation #gg_cat_order_9 gg_config = @s gg_config
tag @e[tag=gg_sel] add gg_used
tag @e[tag=gg_sel] remove gg_sel
...
execute store result score #gg_gun_idx_7 gg_config run random value 1..9
execute store result score #gg_gun_idx_8 gg_config run random value 1..6
execute store result score #gg_gun_idx_9 gg_config run random value 1..17
