...
execute if score #gg_stage_blue gg_config matches 7 run scoreboard players operation #gg_cur_cat_blue gg_config = #gg_cat_order_7 gg_config
execute if score #gg_stage_blue gg_config matches 8 run scoreboard players operation #gg_cur_cat_blue gg_config = #gg_cat_order_8 gg_config
execute if score #gg_stage_blue gg_config matches 9 run scoreboard players operation #gg_cur_cat_blue gg_config = #gg_cat_order_9 gg_config
...
execute if score #gg_cur_cat_blue gg_config matches 7 run scoreboard players operation #gg_cur_gun_blue gg_config = #gg_gun_idx_7 gg_config
execute if score #gg_cur_cat_blue gg_config matches 8 run scoreboard players operation #gg_cur_gun_blue gg_config = #gg_gun_idx_8 gg_config
execute if score #gg_cur_cat_blue gg_config matches 9 run scoreboard players operation #gg_cur_gun_blue gg_config = #gg_gun_idx_9 gg_config
