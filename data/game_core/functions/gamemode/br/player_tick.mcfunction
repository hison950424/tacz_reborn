...
execute if score @s gd656killicon.death matches 6 if score @s death_prev matches 0 run function game_core:gamemode/arms_race/score_debug
...
execute if entity @s[tag=br_jumped,tag=!was_on_cart,nbt={OnGround:1b}] if score @s jump_time matches 20.. run function game_core:gamemode/br/deploy/on_landed
...
execute if score @s br_death_state matches 2 if score @s br_health matches ..6 run function game_core:gamemode/br/force_dead

# --- [0] 初始化檢查 ---
execute unless entity @s[tag=br_setup] run function game_core:gamemode/br/player_setup
...
execute if score @s vanilla_death > @s death_prev run function game_core:gamemode/br/on_death
...
execute if score @s br_death_state matches 3..4 if score #target_alive br_sys matches 0 run function game_core:gamemode/br/spectator
...
execute if score @s br_death_state matches 3..4 unless entity @a[tag=current_target_temp,distance=..1] run function game_core:gamemode/br/spectator
tag @a remove current_target_temp

execute if score @s br_death_state matches 3..4 run function game_core:gamemode/br/spectator_ui
...
execute if entity @s[tag=br_downed,tag=has_slime] as @e[type=villager,tag=revive_success] if score @s br_id = #current_player br_id as @a[tag=is_checking,limit=1] run function game_core:gamemode/br/on_revived
...
execute if entity @s[tag=br_downed,tag=has_slime] if score @s slime_alive matches 0 as @a[tag=is_checking,limit=1] run function game_core:gamemode/br/eliminated
...
# --- [11] 靈魂拾取系統 ---
execute if score @s br_death_state matches 1 if score @s sneak_time matches 1.. at @s as @e[type=marker,tag=br_soul_marker,distance=..0.75] if score @s team_id = #current_player team_id run function game_core:gamemode/br/soul/pickup
...
execute if score @s altar_progress matches 200.. run function game_core:gamemode/br/altar/execute
