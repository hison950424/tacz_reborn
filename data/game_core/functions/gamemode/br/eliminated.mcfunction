...
execute as @e[type=marker,tag=my_tracker] run function game_core:gamemode/br/eliminated_effects
...
execute if entity @s[tag=br_used_altar] run function game_core:gamemode/br/force_dead

# 情況 B：孤狼玩家 (Solo) -> 沒有隊友可以撿靈魂，強制轉入狀態 4
execute if score @s team_id matches 5 run function game_core:gamemode/br/force_dead
