...
execute if score #global br_phase matches 0 run function game_core:gamemode/br/phase/countdown_tick

# Phase 1 (空投部署)：執行空投機移動、跟隨、著陸偵測等邏輯
execute if score #global br_phase matches 1 run function game_core:gamemode/br/deploy/tick
...
execute if score #global br_phase matches 1..2 as @a at @s run function game_core:gamemode/br/player_tick
execute if score #global br_phase matches 1..2 as @e[type=villager,tag=br_downed_mob] at @s run function game_core:gamemode/br/downed_tick
...
# ==========================================
# 執行靈魂標籤的視覺特效
execute if score #global br_phase matches 1..2 if score #global br_timer matches 20 as @e[type=marker,tag=br_soul_marker] at @s run function game_core:gamemode/br/soul/tick
#靈魂祭壇
...
execute if score #global br_phase matches 1..2 if score #br_stand_red br_sys matches 0 as @a[team=red,scores={br_death_state=2..3}] run function game_core:gamemode/br/force_dead
...
# ── 階段切換 ──
execute if score #br_phase dummy matches 0 if score #br_timer dummy matches ..0 run function game_core:gamemode/br/phase/phase1_start
execute if score #br_phase dummy matches 1 if score #br_timer dummy matches ..0 run function game_core:gamemode/br/phase/phase2_start
execute if score #br_phase dummy matches 2 if score #br_timer dummy matches ..0 run function game_core:gamemode/br/phase/phase3_start
execute if score #br_phase dummy matches 3 if score #br_timer dummy matches ..0 run function game_core:gamemode/br/phase/phase4_start
execute if score #br_phase dummy matches 4 if score #br_timer dummy matches ..0 run function game_core:gamemode/br/phase/phase5_start
execute if score #br_phase dummy matches 5 if score #br_timer dummy matches ..0 run function game_core:gamemode/br/phase/phase6_start
execute if score #br_phase dummy matches 6 if score #br_timer dummy matches ..0 run function game_core:gamemode/br/phase/phase7_start
execute if score #br_phase dummy matches 7 if score #br_timer dummy matches ..0 run function game_core:gamemode/br/phase/phase8_start
execute if score #br_phase dummy matches 8 if score #br_timer dummy matches ..0 run function game_core:gamemode/br/phase/phase9_start
...
execute if score #br_airdrop_delay dummy matches 20.. if entity @e[type=minecraft:villager,tag=airdrop_bird] run function game_core:gamemode/br/airdrop/check
