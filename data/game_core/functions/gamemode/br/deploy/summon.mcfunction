...
# === [2] 動態物資佈署 ===
function game_core:gamemode/br/airdrop/loot_spawn

# === [3] 縮圈系統佈署 ===
# 載入地圖設定（worldborder center/size + #map 座標）
execute if score #global br_map matches 1 run function game_core:gamemode/br/map/map1
execute if score #global br_map matches 2 run function game_core:gamemode/br/map/map2
execute if score #global br_map matches 3 run function game_core:gamemode/br/map/map3
execute if score #global br_map matches 4 run function game_core:gamemode/br/map/map4
execute if score #global br_map matches 5 run function game_core:gamemode/br/map/map5

# 進入準備期（同時預算所有圓心）
function game_core:gamemode/br/phase/phase0_start

# 快速模式：預算完成後，跳過 Phase 0/1，直接設定 Phase 2 狀態
execute if score #global br_fast_mode matches 1 run function game_core:gamemode/br/phase/phase0_fast
