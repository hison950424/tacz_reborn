...
execute as @a[tag=br_on_cart,scores={sneak_time=1..}] run function game_core:gamemode/br/deploy/on_jumped
...
execute if score #deploy_ticks br_sys matches ..0 as @a[tag=br_on_cart] run function game_core:gamemode/br/deploy/on_jumped
