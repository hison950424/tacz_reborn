...
execute if score #global br_fast_mode matches 0 run tellraw @a ["",{"text":"[縮圈] ","color":"dark_red"},{"text":"第三次縮圈開始！","color":"yellow"}]
execute if score #global br_fast_mode matches 1 run tellraw @a ["",{"text":"[縮圈] ","color":"dark_red"},{"text":"第二次縮圈開始！","color":"yellow"}]
