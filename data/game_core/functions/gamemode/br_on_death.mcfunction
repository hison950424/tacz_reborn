...
execute if score @s br_death_state matches 2..3 run tag @s add cause_void
execute if score @s br_death_state matches 2..3 run function game_core:gamemode/br_force_state4
...
execute if entity @s[tag=br_downed_processing] run title @s subtitle {"text":"請盡量待在安全處等待隊友救援","color":"gray"}
