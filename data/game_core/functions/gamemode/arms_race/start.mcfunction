...
execute if score #global game_state matches 0 as @a run function game_core:class/apply
execute if score #global game_state matches 0 as @a run function game_core:class/give_gear
execute if score #global game_state matches 0 as @a run function game_core:class/reset_throwables
execute if score #global game_state matches 0 as @a run function game_core:class/give_ammo
...
execute if score #global arms_sub_mode matches 1 run function game_core:gamemode/tdm/ui_init
...
# 槍王之王由 gamemode/gk/start.mcfunction 獨立處理，不在此執行。
