...
# 遊戲時間結束判定
execute if score #global game_state matches 2 if score #global arms_sub_mode matches 2 if score #global dom_arms_timer >= #time_limit_sec dom_config run function game_core:gamemode/dom/time_up
