...
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #a_contested temp_score matches 0 if score #a_red_count temp_score matches 1.. if score #Point_a dom_state matches 1 at @e[type=marker,tag=Point_a] positioned ~-4 ~-1 ~-4 as @a[dx=7,dy=3,dz=7,team=red] run scoreboard players add @s stat_dom_caps 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #a_contested temp_score matches 0 if score #a_red_count temp_score matches 1.. if score #Point_a dom_state matches 3 at @e[type=marker,tag=Point_a] positioned ~-4 ~-1 ~-4 as @a[dx=7,dy=3,dz=7,team=red] run scoreboard players add @s stat_dom_caps_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #a_contested temp_score matches 0 if score #a_red_count temp_score matches 1.. if score #Point_a dom_state matches 3 at @e[type=marker,tag=Point_a] positioned ~-4 ~-1 ~-4 as @a[dx=7,dy=3,dz=7,team=red] run scoreboard players add @s stat_dom_caps 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #a_contested temp_score matches 0 if score #a_blue_count temp_score matches 1.. if score #Point_a dom_state matches 1 at @e[type=marker,tag=Point_a] positioned ~-4 ~-1 ~-4 as @a[dx=7,dy=3,dz=7,team=blue] run scoreboard players add @s stat_dom_caps_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #a_contested temp_score matches 0 if score #a_blue_count temp_score matches 1.. if score #Point_a dom_state matches 1 at @e[type=marker,tag=Point_a] positioned ~-4 ~-1 ~-4 as @a[dx=7,dy=3,dz=7,team=blue] run scoreboard players add @s stat_dom_caps 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #a_contested temp_score matches 0 if score #a_blue_count temp_score matches 1.. if score #Point_a dom_state matches 2 at @e[type=marker,tag=Point_a] positioned ~-4 ~-1 ~-4 as @a[dx=7,dy=3,dz=7,team=blue] run scoreboard players add @s stat_dom_caps_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #a_contested temp_score matches 0 if score #a_blue_count temp_score matches 1.. if score #Point_a dom_state matches 2 at @e[type=marker,tag=Point_a] positioned ~-4 ~-1 ~-4 as @a[dx=7,dy=3,dz=7,team=blue] run scoreboard players add @s stat_dom_caps 1
# A點 守點貢獻（己方佔領 + 未爭奪 + 在點內）
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #Point_a dom_state matches 2 if score #a_contested temp_score matches 0 at @e[type=marker,tag=Point_a] positioned ~-4 ~-1 ~-4 as @a[dx=7,dy=3,dz=7,team=red] run scoreboard players add @s stat_dom_def_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #Point_a dom_state matches 2 if score #a_contested temp_score matches 0 at @e[type=marker,tag=Point_a] positioned ~-4 ~-1 ~-4 as @a[dx=7,dy=3,dz=7,team=red] run scoreboard players add @s stat_dom_def 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #Point_a dom_state matches 3 if score #a_contested temp_score matches 0 at @e[type=marker,tag=Point_a] positioned ~-4 ~-1 ~-4 as @a[dx=7,dy=3,dz=7,team=blue] run scoreboard players add @s stat_dom_def_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #Point_a dom_state matches 3 if score #a_contested temp_score matches 0 at @e[type=marker,tag=Point_a] positioned ~-4 ~-1 ~-4 as @a[dx=7,dy=3,dz=7,team=blue] run scoreboard players add @s stat_dom_def 1
...
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #b_contested temp_score matches 0 if score #b_red_count temp_score matches 1.. if score #Point_b dom_state matches 1 at @e[type=marker,tag=Point_b] positioned ~-5 ~-1 ~-5 as @a[dx=9,dy=3,dz=9,team=red] run scoreboard players add @s stat_dom_caps 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #b_contested temp_score matches 0 if score #b_red_count temp_score matches 1.. if score #Point_b dom_state matches 3 at @e[type=marker,tag=Point_b] positioned ~-5 ~-1 ~-5 as @a[dx=9,dy=3,dz=9,team=red] run scoreboard players add @s stat_dom_caps_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #b_contested temp_score matches 0 if score #b_red_count temp_score matches 1.. if score #Point_b dom_state matches 3 at @e[type=marker,tag=Point_b] positioned ~-5 ~-1 ~-5 as @a[dx=9,dy=3,dz=9,team=red] run scoreboard players add @s stat_dom_caps 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #b_contested temp_score matches 0 if score #b_blue_count temp_score matches 1.. if score #Point_b dom_state matches 1 at @e[type=marker,tag=Point_b] positioned ~-5 ~-1 ~-5 as @a[dx=9,dy=3,dz=9,team=blue] run scoreboard players add @s stat_dom_caps_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #b_contested temp_score matches 0 if score #b_blue_count temp_score matches 1.. if score #Point_b dom_state matches 1 at @e[type=marker,tag=Point_b] positioned ~-5 ~-1 ~-5 as @a[dx=9,dy=3,dz=9,team=blue] run scoreboard players add @s stat_dom_caps 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #b_contested temp_score matches 0 if score #b_blue_count temp_score matches 1.. if score #Point_b dom_state matches 2 at @e[type=marker,tag=Point_b] positioned ~-5 ~-1 ~-5 as @a[dx=9,dy=3,dz=9,team=blue] run scoreboard players add @s stat_dom_caps_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #b_contested temp_score matches 0 if score #b_blue_count temp_score matches 1.. if score #Point_b dom_state matches 2 at @e[type=marker,tag=Point_b] positioned ~-5 ~-1 ~-5 as @a[dx=9,dy=3,dz=9,team=blue] run scoreboard players add @s stat_dom_caps 1
# B點 守點貢獻
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #Point_b dom_state matches 2 if score #b_contested temp_score matches 0 at @e[type=marker,tag=Point_b] positioned ~-5 ~-1 ~-5 as @a[dx=9,dy=3,dz=9,team=red] run scoreboard players add @s stat_dom_def_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #Point_b dom_state matches 2 if score #b_contested temp_score matches 0 at @e[type=marker,tag=Point_b] positioned ~-5 ~-1 ~-5 as @a[dx=9,dy=3,dz=9,team=red] run scoreboard players add @s stat_dom_def 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #Point_b dom_state matches 3 if score #b_contested temp_score matches 0 at @e[type=marker,tag=Point_b] positioned ~-5 ~-1 ~-5 as @a[dx=9,dy=3,dz=9,team=blue] run scoreboard players add @s stat_dom_def_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #Point_b dom_state matches 3 if score #b_contested temp_score matches 0 at @e[type=marker,tag=Point_b] positioned ~-5 ~-1 ~-5 as @a[dx=9,dy=3,dz=9,team=blue] run scoreboard players add @s stat_dom_def 1
...
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #c_contested temp_score matches 0 if score #c_red_count temp_score matches 1.. if score #Point_c dom_state matches 1 at @e[type=marker,tag=Point_c] positioned ~-8 ~-1 ~-8 as @a[dx=15,dy=3,dz=15,team=red] run scoreboard players add @s stat_dom_caps 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #c_contested temp_score matches 0 if score #c_red_count temp_score matches 1.. if score #Point_c dom_state matches 3 at @e[type=marker,tag=Point_c] positioned ~-8 ~-1 ~-8 as @a[dx=15,dy=3,dz=15,team=red] run scoreboard players add @s stat_dom_caps_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #c_contested temp_score matches 0 if score #c_red_count temp_score matches 1.. if score #Point_c dom_state matches 3 at @e[type=marker,tag=Point_c] positioned ~-8 ~-1 ~-8 as @a[dx=15,dy=3,dz=15,team=red] run scoreboard players add @s stat_dom_caps 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #c_contested temp_score matches 0 if score #c_blue_count temp_score matches 1.. if score #Point_c dom_state matches 1 at @e[type=marker,tag=Point_c] positioned ~-8 ~-1 ~-8 as @a[dx=15,dy=3,dz=15,team=blue] run scoreboard players add @s stat_dom_caps_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #c_contested temp_score matches 0 if score #c_blue_count temp_score matches 1.. if score #Point_c dom_state matches 1 at @e[type=marker,tag=Point_c] positioned ~-8 ~-1 ~-8 as @a[dx=15,dy=3,dz=15,team=blue] run scoreboard players add @s stat_dom_caps 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #c_contested temp_score matches 0 if score #c_blue_count temp_score matches 1.. if score #Point_c dom_state matches 2 at @e[type=marker,tag=Point_c] positioned ~-8 ~-1 ~-8 as @a[dx=15,dy=3,dz=15,team=blue] run scoreboard players add @s stat_dom_caps_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #c_contested temp_score matches 0 if score #c_blue_count temp_score matches 1.. if score #Point_c dom_state matches 2 at @e[type=marker,tag=Point_c] positioned ~-8 ~-1 ~-8 as @a[dx=15,dy=3,dz=15,team=blue] run scoreboard players add @s stat_dom_caps 1
# C點 守點貢獻
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #Point_c dom_state matches 2 if score #c_contested temp_score matches 0 at @e[type=marker,tag=Point_c] positioned ~-8 ~-1 ~-8 as @a[dx=15,dy=3,dz=15,team=red] run scoreboard players add @s stat_dom_def_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #Point_c dom_state matches 2 if score #c_contested temp_score matches 0 at @e[type=marker,tag=Point_c] positioned ~-8 ~-1 ~-8 as @a[dx=15,dy=3,dz=15,team=red] run scoreboard players add @s stat_dom_def 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #Point_c dom_state matches 3 if score #c_contested temp_score matches 0 at @e[type=marker,tag=Point_c] positioned ~-8 ~-1 ~-8 as @a[dx=15,dy=3,dz=15,team=blue] run scoreboard players add @s stat_dom_def_match 1
execute if score #global arms_sub_mode matches 2 if score #100tick dom_timer matches 100 if score #Point_c dom_state matches 3 if score #c_contested temp_score matches 0 at @e[type=marker,tag=Point_c] positioned ~-8 ~-1 ~-8 as @a[dx=15,dy=3,dz=15,team=blue] run scoreboard players add @s stat_dom_def 1
