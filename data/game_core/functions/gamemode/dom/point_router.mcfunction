...
execute if score #global arms_sub_mode matches 2 at @e[type=marker,tag=Point_a] positioned ~-4 ~-1 ~-4 as @a[dx=7,dy=3,dz=7,gamemode=adventure] as @s run function game_core:gamemode/dom/detect_a
...
execute if score #global arms_sub_mode matches 2 at @e[type=marker,tag=Point_b] positioned ~-5 ~-1 ~-5 as @a[dx=9,dy=3,dz=9,gamemode=adventure] as @s run function game_core:gamemode/dom/detect_b
...
execute if score #global arms_sub_mode matches 2 at @e[type=marker,tag=Point_c] positioned ~-8 ~-1 ~-8 as @a[dx=15,dy=3,dz=15,gamemode=adventure] as @s run function game_core:gamemode/dom/detect_c
