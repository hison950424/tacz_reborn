...
execute if entity @s[tag=Point_a] run scoreboard players add #dom_open_count dom_config 1
execute if entity @s[tag=Point_a] run tellraw @a {"text":"[系統] 本回合開啟 A 點！","color":"yellow","bold":true}
...
execute if entity @s[tag=Point_b] run scoreboard players add #dom_open_count dom_config 1
execute if entity @s[tag=Point_b] run tellraw @a {"text":"[系統] 本回合開啟 B 點！","color":"yellow","bold":true}
...
execute if entity @s[tag=Point_c] run scoreboard players add #dom_open_count dom_config 1
execute if entity @s[tag=Point_c] run tellraw @a {"text":"[系統] 本回合開啟 C 點！","color":"yellow","bold":true}
