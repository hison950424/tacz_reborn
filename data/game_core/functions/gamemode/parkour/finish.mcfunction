...
# 目的: 玩家踩到跑酷終點壓力板時執行
# 觸發方式: 終點壓力板旁的指令方塊
#   execute as @a[tag=on_parkour,distance=..3] run function game_core:gamemode/parkour/finish
# ==========================================
...
# 個人最佳判定
execute if score @s park_best_sec < @s park_best run function game_core:gamemode/parkour/new_record
