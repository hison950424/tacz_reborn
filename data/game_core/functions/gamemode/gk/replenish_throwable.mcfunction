...
execute if score #gk_gun_idx_8 gk_config matches 5 store result score @s gk_tmp run clear @s lrtactical:throwable{ThrowableId:"suffuse:m24"} 0
execute if score #gk_gun_idx_8 gk_config matches 5 if score @s gk_tmp matches 0 run give @s lrtactical:throwable{ThrowableId:"suffuse:m24"} 1
