...
# 特例：minigun 彈藥無限，不設定 GunCurrentAmmoCount
...
execute if score #gk_give_gun gk_config matches 3 run give @s tacz:modern_kinetic_gun{GunId:"tacz:minigun",GunFireMode:"AUTO"} 1
