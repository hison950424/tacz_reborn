...
## 記得更改map* ##
# --- 一般物資 (棕色) ---
execute if block ~ ~ ~ stripped_acacia_wood run summon marker ~ ~ ~ {Tags:["loot_marker","crate_general","map_1"]}
...
# --- 醫療物資 (紅色) ---
execute if block ~ ~ ~ stripped_crimson_hyphae run summon marker ~ ~ ~ {Tags:["loot_marker","crate_medical","map_1"]}
...
# --- 配件物資 (青色) ---
execute if block ~ ~ ~ stripped_warped_hyphae run summon marker ~ ~ ~ {Tags:["loot_marker","crate_attach","map_1"]}
...
# --- 高階物資 (紫色) ---
execute if block ~ ~ ~ waxed_exposed_copper run summon marker ~ ~ ~ {Tags:["loot_marker","crate_high","map_1"]}
