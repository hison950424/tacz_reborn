# ==========================================
# 檔案: shop/buy_hk_mp5a5.mcfunction
# ==========================================
...
execute if score @s class_type matches 3 run playsound entity.villager.no master @s ~ ~ ~ 1 1
...
gd656killicon server statistics add score @s -260
tellraw @s ["",{"text":"[商店] 成功購買 hk_mp5a5 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]