# ==========================================
# 檔案: shop/buy_p90.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"p90"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:p90",GunFireMode:"AUTO"} 1
playsound block.anvil.use master @s ~ ~ ~ 1 1.2
gd656killicon server statistics add score @s -380
tellraw @s ["",{"text":"[商店] 成功購買 p90 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]