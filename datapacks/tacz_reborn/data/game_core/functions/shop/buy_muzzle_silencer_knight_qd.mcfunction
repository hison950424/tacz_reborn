# ==========================================
# 檔案: shop/buy_muzzle_silencer_knight_qd.mcfunction
# 觸發: 玩家把「假 Knight QD 滅音器」拿進背包的瞬間
# ==========================================

clear @s tacz:attachment{ShopItem:"muzzle_silencer_knight_qd"}
...
give @s tacz:attachment{AttachmentId:"tacz:muzzle_silencer_knight_qd"} 1
...
tellraw @s ["",{"text":"[商店] 成功購買 Knight QD 滅音器 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]