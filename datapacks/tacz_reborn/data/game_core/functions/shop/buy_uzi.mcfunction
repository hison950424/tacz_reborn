# ==========================================
# 檔案: shop/buy_uzi.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"uzi"}
...
give @s tacz:modern_kinetic_gun{GunId:"tacz:uzi",GunFireMode:"AUTO"} 1
playsound block.anvil.use master @s ~ ~ ~ 1 1.2
gd656killicon server statistics add score @s -180
tellraw @s ["",{"text":"[商店] 成功購買 uzi ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]