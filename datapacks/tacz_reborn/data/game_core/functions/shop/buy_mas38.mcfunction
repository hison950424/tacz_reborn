# ==========================================
# 檔案: shop/buy_mas38.mcfunction
# ==========================================
clear @s tacz:modern_kinetic_gun{ShopItem:"mas38"}
...
scoreboard players set @s shop_price 190
...
give @s tacz:modern_kinetic_gun{GunId:"suffuse:mas38",GunFireMode:"AUTO"} 1
playsound block.anvil.use master @s ~ ~ ~ 1 1.2
gd656killicon server statistics add score @s -190
tellraw @s ["",{"text":"[商店] 成功購買 mas38 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]