# ==========================================
# 檔案: shop/buy_sight_srs_02.mcfunction
# 觸發: 玩家把「假 TriJicon SRS-02 瞄準鏡」拿進背包的瞬間
# ==========================================
...
tellraw @s ["",{"text":"[商店] 成功購買 SRS-02 瞄具 ！剩餘餘額：","color":"green"},{"score":{"name":"@s","objective":"gd656killicon.score"},"color":"yellow"},{"text":" 元。","color":"green"}]